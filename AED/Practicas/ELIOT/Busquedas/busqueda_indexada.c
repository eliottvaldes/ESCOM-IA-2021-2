/**
 * @file busqueda_indexada.c
 * @author VALDES LUIS ELIOT FABIAN
 * @brief Programa que contiene algoritmos de busqueda secuencial, binaria e indexada
 * @version 0.1
 * @date 2022-03-11
 *
...
int *generarArrayIndices(int extensionDeArreglo, int rangoDeArreglo)
{
    ...
    do
    {
        ...
        case 5:
            ...
            if (esArregloExistente == true)
            {
                ...
                // ejecutamos la funcion para la busqueda binaria
                busquedaIndexada(arrayNumerico, arrayIndices, extensionDeArreglo, numeroABuscar);
